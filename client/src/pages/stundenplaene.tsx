...
export default function Stundenplaene() {
  ...
  const teacherSummary = useMemo(() => {
    ...
    teacherAssignments.forEach(assignment => {
      ...
      // Check for Differenzierung parallel group
      const parallelGroup = assignment.subject?.parallelGroup;
      const grade = assignment.class?.grade ?? 'na';
                                        ...
                                        {(group.semester1 || group.semester2) && (
                                          <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                              ...
                                              <AlertDialogFooter className={group.semester1 && group.semester2 ? "flex-col sm:flex-col gap-2 items-stretch" : ""}>
                                                {group.semester1 && group.semester2 ? (
                                                  <>
                                                    <AlertDialogAction
                                                      onClick={() => deleteAssignment(group.semester1!.id)}
                                                      className="bg-orange-600 hover:bg-orange-700 w-full m-0"
                                                    ...
                                                    <AlertDialogCancel className="w-full m-0 mt-2">Abbrechen</AlertDialogCancel>
                                                  </>
                                                ) : (
                                                  <>
                                    ...
                                    <AlertDialog>
                                      ...
                                      <AlertDialogContent>
                                        ...
                                        <AlertDialogFooter className={(() => {
                                          ...
                                          return siblingAssignment ? "flex-col sm:flex-col gap-2 items-stretch" : "";
                                        })()}>
                                          {(() => {
                                            const otherSemester = assignment.semester === '1' ? '2' : '1';
                                            const siblingAssignment = classAssignments.find(a => 
