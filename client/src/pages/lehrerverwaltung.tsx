                          ...
                          <FormControl>
                            <Select>
                              ...
                              <SelectContent className="max-h-[300px]">
                                {subjects
                                  .sort((a, b) => {
                                    // AG-Fächer ans Ende (sowohl "AG xyz" als auch "xyz AG")
                                    const aIsAG = a.name.startsWith('AG ') || a.name.endsWith(' AG');
                                    const bIsAG = b.name.startsWith('AG ') || b.name.endsWith(' AG');
