...
const MatrixCell = React.memo(({ 
  ...
  return (
    <td className="px-0 py-1 border-r" style={{ width: '70px', maxWidth: '70px', minWidth: '70px' }}>
      <div className="flex flex-col gap-0.5">
        {/* 1. Halbjahr Dropdown + Hours Dropdown */}
        <div className="flex flex-col gap-0">
          <div className="flex items-center gap-0">
            <span className="text-[9px] text-muted-foreground font-medium" style={{ width: '8px' }}>1</span>
            <Select
            ...
            >
              <SelectTrigger className="h-5 text-[9px] px-0.5" data-testid={`select-hours-s1-${classId}-${subjectId}`} style={{ width: '26px', minWidth: '26px', maxWidth: '26px' }}>
                <SelectValue placeholder="--" />
              </SelectTrigger>
              <SelectContent>
        ...
        <div className="flex flex-col gap-0">
          <div className="flex items-center gap-0">
            <span className="text-[9px] text-muted-foreground font-medium" style={{ width: '8px' }}>2</span>
            <Select
            ...
            >
              <SelectTrigger className="h-5 text-[9px] px-0.5" data-testid={`select-hours-s2-${classId}-${subjectId}`} style={{ width: '26px', minWidth: '26px', maxWidth: '26px' }}>
                <SelectValue placeholder="--" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="1">1h</SelectItem>
              ...
              <table className="table-fixed border-collapse">
                <thead>
                  <tr className="border-b bg-muted/50">
                    <th className="text-left p-2 font-medium text-xs border-r bg-muted/80 sticky left-0 z-10" style={{ width: '80px' }}>KLASSE</th>
                    {filteredSubjects.map(subject => (
                      <th key={subject.id} className="text-center px-0 py-1 font-medium text-[10px] border-r" style={{ width: '70px', maxWidth: '70px', minWidth: '70px' }}>
